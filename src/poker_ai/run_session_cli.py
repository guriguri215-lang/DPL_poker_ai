...
limited to facing an all-in; explicit R007, R001, R002, and R003 fixtures select bounded OOP
...
def _parser(*, entrypoint: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        choices=("LEAK_R001", "LEAK_R002", "LEAK_R003", "LEAK_R007", "LEAK_R008"),
        default="LEAK_R008",
        help=(
